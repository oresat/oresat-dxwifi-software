...
#           https://docs.google.com/document/d/16b_Qd6Pj2IAk5HQQl7JAP1T9Qd6QbKICMd-0swd9L6Y/edit
...
class TemperatureResource(Resource):
    ...
    def __init__(self, adc_thermistor_pin=6, is_mock_adc=False):
        ...
        Args:
            adc_thermistor_pin (int, optional): Pin where the voltage is read. Defaults to 6.
            is_mock_adc (bool, optional): False=real world ADC, True=mock ADC. Defaults to False.
        """
        super().__init__()
