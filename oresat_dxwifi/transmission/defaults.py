...
# Not all of them are being used in transmission.py, but they'll be necessary to know
# if oresat-libdxwifi's python bindins are to be integrated at a deeper level.
